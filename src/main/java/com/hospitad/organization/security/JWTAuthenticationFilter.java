...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    // TODO: read from properties before going to production
    public static final String JWT_SECRET = "d4r5u8x/A%D*G-KaPdSgCkYp5d6v9y$C&E(H+MbQeThWmZq4t7w!z%C*F-J@NcRf";

    public static final String TOKEN_TYPE = "JWT";

    public JWTAuthenticationFilter(AuthenticationManager authenticationManager, ObjectMapper objectMapper, HandlerExceptionResolver resolver) {
